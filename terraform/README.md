...
```
curl "https://www.nubesgen.com/demo.zip?iactool=TERRAFORM&region=eastus&application=SPRING_CLOUD.basic&runtime=DOCKER&database=SQL_SERVER.general_purpose&addons=cosmosdb_mongodb,redis,storage_blob&gitops=true" | tar -xzvf -
```
